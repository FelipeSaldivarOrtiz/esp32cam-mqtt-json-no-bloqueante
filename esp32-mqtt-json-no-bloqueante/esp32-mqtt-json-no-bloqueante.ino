...
Enviar JSON por MQTT con el ESP32CAM - No bloqueante
por: Hugo Escalpelo
Fecha: 5 de julio de 2023

Este programa envía un mensaje JSON vía MQTT con el ESP32CAM. Los valores
del mensaje son aleatoreos. En las variables se indica el tema MQTT
en el que se envìa y recibe información. Para ello es necesario configurar
el nombre de red e IP del broker MQTT. 

No se requiere hardware adicional al programador.
